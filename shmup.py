...
def draw_shield_bar(surf, x, y, pct):
    ...
    # TODO: Make the shield bar change colour depending on the shield level
...
meteor_images = []
meteor_list = ['PNG/Meteors/meteorBrown_big1.png', 'PNG/Meteors/meteorBrown_big2.png',
               'PNG/Meteors/meteorBrown_med1.png', 'PNG/Meteors/meteorBrown_med3.png',
               'PNG/Meteors/meteorBrown_small1.png', 'PNG/Meteors/meteorBrown_small2.png',
...
for snd in ['expl1.wav', 'expl2.wav']:
    ...
    pygame.mixer.Sound(path.join(snd_dir, snd)).set_volume(0.1)
